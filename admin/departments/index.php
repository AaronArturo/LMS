...
<div class="card card-outline card-primary rounded-0 shadow">
	<div class="card-header">
		<h3 class="card-title">Lista de Licenciaturas</h3>
		<?php if ($_settings->userdata('type') == 1) : ?>
			<div class="card-tools">
				<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span> Agregar Licenciaturas</a>
			</div>
		<?php endif; ?>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function() {
		$('#create_new').click(function() {
			uni_modal("Agregar Departamento", "departments/manage_department.php")
		})
		$('.view_data').click(function() {
			uni_modal("Departamento", "departments/view_department.php?id=" + $(this).attr('data-id'))
		})
		$('.edit_data').click(function() {
			uni_modal("Actualizar Información Departamento", "departments/manage_department.php?id=" + $(this).attr('data-id'))
		})
