	...
	<div class="card-header">
		...
		<?php if ($_settings->userdata('type') == 1) : ?>
			<div class="card-tools">
				<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span> Agregar Clase</a>
			</div>
		<?php endif; ?>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function() {
		$('#create_new').click(function() {
			uni_modal("Agregar Clase Nueva", "courses/manage_course.php")
		})
		$('.view_data').click(function() {
			uni_modal("Clase", "courses/view_course.php?id=" + $(this).attr('data-id'))
		})
		$('.edit_data').click(function() {
			uni_modal("Actualizar Información Clase", "courses/manage_course.php?id=" + $(this).attr('data-id'))
		})
		$('.delete_data').click(function() {
			_conf("¿Estás seguro de eliminar este clase de forma permanente?", "delete_course", [$(this).attr('data-id')])
		})
